...
public class WithdrawAmount extends HttpServlet{
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String withdrawnAmountInString = req.getParameter("withdraw");
		double withdrawnAmount = Double.parseDouble(withdrawnAmountInString);
		...
		for(BankAccount account: accounts) {
			if(account.getAccountNumber() == currentUser.getAccountNumber()) {
				...
				newBalance = account.getBalance() - withdrawnAmount;
